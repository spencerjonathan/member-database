...
<div class="container-fluid">
	...
	<?php $currentdistrictid = 0; $firstdistrict=1;
	foreach ($this->towers as $tower) : 
		if ($currentdistrictid != $tower->district_id) : $currentdistrictid = $tower->district_id; ?>
			<h1 <?php if ($firstdistrict) { echo 'class="firstdistrict"'; $firstdistrict=0; } ?> align="center"><?php echo $this->districts[$tower->district_id] ?></h1>
